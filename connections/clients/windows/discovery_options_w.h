...
#ifndef WINDOWS_DISCOVERY_OPTIONS_W_H_
#define WINDOWS_DISCOVERY_OPTIONS_W_H_
#include <string>
...
struct DLL_API DiscoveryOptionsW : OptionsBaseW {
...
#endif  // WINDOWS_DISCOVERY_OPTIONS_W_H_
