...
#include "third_party/nearby/cpp/core/advertising_options.h"
#include "third_party/nearby/cpp/core/internal/mediums/ble_v2/discovered_peripheral_callback.h"
#include "third_party/nearby/cpp/core/internal/mediums/ble_v2/discovered_peripheral_tracker.h"
...
#include "third_party/nearby/cpp/platform/public/mutex_lock.h"
#include "third_party/nearby/cpp/platform/public/single_thread_executor.h"
...
class BleV2 final {
 ...
 private:
  ...
  ProcessFetchGattAdvertisementsRequest(
      mediums::BlePeripheral& peripheral, int num_slots,
  ...
  ByteArray CreateAdvertisementHeader() ABSL_EXCLUSIVE_LOCKS_REQUIRED(mutex_);
