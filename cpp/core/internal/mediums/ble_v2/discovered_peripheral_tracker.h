...
#include "third_party/nearby/cpp/core/internal/mediums/lost_entity_tracker.h"
...
class DiscoveredPeripheralTracker {
 ...
 private:
  ...
  // Used in gatt_advertisement_infos_ map.
  struct GattAdvertisementInfo {
    // Tracks what GATT advertisements are currently active. Used to determine
    // which LostEntityTracker to invoke when advertisements are rediscovered.
