...
#include "third_party/nearby/cpp/core/internal/mediums/ble_v2/ble_peripheral.h"
...
#include "third_party/nearby/cpp/core/power_level.h"
...
BleV2::GetAdvertisementFetcher() {
  return {
      .fetch_advertisements =
          [this](mediums::BlePeripheral& peripheral, int num_slots,
                 mediums::AdvertisementReadResult* advertisement_read_result)
          -> std::unique_ptr<mediums::AdvertisementReadResult> {
