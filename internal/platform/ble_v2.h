...
class ServerGattConnection final {
 public:
  ...
  explicit ServerGattConnection(
      std::unique_ptr<api::ble_v2::ServerGattConnection> server_gatt_connection)
 ...
 private:
  api::ble_v2::ServerGattConnection* impl_;
};

class GattServer final {
 public:
  GattServer() = default;
  explicit GattServer(api::ble_v2::GattServer* gatt_server)
      : impl_(gatt_server) {}
  ...
  api::ble_v2::GattServer& GetImpl() { return *impl_; }

 private:
  std::shared_ptr<api::ble_v2::GattServer> impl_;
};
...
class BleV2Medium final {
 public:
  ...
  api::ble_v2::BleMedium& GetImpl() { return *impl_; }
